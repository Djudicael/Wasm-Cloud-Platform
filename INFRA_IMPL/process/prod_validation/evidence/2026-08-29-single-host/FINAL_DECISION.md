...
| P10-04 | P1, SOURCE REMEDIATED + LOCAL MICROVM PASS / PRODUCTION RECEIVER EVIDENCE PENDING | The 2026-09-02 P10-07 rerun validated the current five files and 35 alerts, including PostgreSQL clock skew, missing clock telemetry, and unavailable time sources. It required 28 always-present metric names and correctly treated both OpenTelemetry send/enqueue failure counters as event-created. Seven operational categories each produced one deduplicated firing and one resolved delivery after three identical submissions. | Production must attach the real authenticated on-call receiver, assign owners and reachable runbooks, validate inhibition/silence/repeat policy and Alertmanager HA, and preserve provider-side firing/resolution evidence. See [P10-07 evidence](../2026-09-01-single-host/P10-07-postgres-clock/README.md), [alerting evidence](../2026-08-30-single-host/P10-04-alerting/README.md), and [runbook](../../../PRODUCTION_ALERTING_VALIDATION.md). |
