...
impl MonitorEvent {
    pub fn event_type(&self) -> EventType {
        match self {
            ...
            MonitorEvent::TcpAccept { .. } => EventType::TcpAccept,
            MonitorEvent::TcpSend { .. } => EventType::TcpSend,
            MonitorEvent::TcpReceive { .. } => EventType::TcpReceive,
            MonitorEvent::FdOpen { .. } => EventType::FdOpen,
            MonitorEvent::FdLimitApproaching { .. } => EventType::FdLimitApproaching,
            MonitorEvent::FdClose { .. } => EventType::FdClose,
            ...
            MonitorEvent::SyscallActivity { .. } => EventType::SyscallActivity,
