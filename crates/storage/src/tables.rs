...
// Key   : sha256 hex string of the raw .wasm bytes
// Value : JSON-serialized ArtifactVerificationRecord
pub const ARTIFACT_VERIFICATIONS: TableDefinition<&str, &str> =
    TableDefinition::new("artifact_verifications");
